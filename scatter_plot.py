...
class Frm_scatter_plot():
    def __init__(self):
        ...
        self.msg="To create a scatter plot we need to enter data in the text file labelled 'scatterplot.txt.\n Click on 'Add points' button.\n Right click on 'scatterplot.txt' and click on 'Open' option from teh listed options to open it.\n Enter data in teh format:\n X1,Y1\nX2,Y2....\nExample:\n3,11\n50,-65...\n Save teh text fiel and click on create buttton to create the scatter plot"
