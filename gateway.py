...
class Gateway:
    def __init__(self):
        ...
        self.msg="PyVision\nYour data visualization companion!!\nPyVision is a unique graph plotter which provides you the option to plot the basic line plots to the complex 3-D plots. This tool can even be used for statistical analysis of teh data with teh help of bar charts, histograms and pie charts. It has teh functionality of even solving the complex trigonometric and logarithmic mixed plots. You name it and we plot it!!"
